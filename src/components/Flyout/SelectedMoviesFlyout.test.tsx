...
describe("SelectedMoviesFlyout", () => {
    ...
    beforeEach(() => {
        useSelectorMock = reactRedux.useSelector as unknown as ReturnType<typeof vi.fn>;
        useDispatchMock = reactRedux.useDispatch as unknown as ReturnType<typeof vi.fn>;
        mockDispatch = vi.fn();
